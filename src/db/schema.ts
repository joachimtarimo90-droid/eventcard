...
export const guests = pgTable("guests", {
  ...
  invitationSmsStatus: text("invitation_sms_status").default("Sijatuma"),
  invitationWhatsappStatus: text("invitation_whatsapp_status").default("Sijatuma"),
  reminderSmsStatus: text("reminder_sms_status").default("Sijatuma"),
  reminderWhatsappStatus: text("reminder_whatsapp_status").default("Sijatuma"),
  thankYouSmsStatus: text("thank_you_sms_status").default("Sijatuma"),
  thankYouWhatsappStatus: text("thank_you_whatsapp_status").default("Sijatuma"),
  lastSentChannel: text("last_sent_channel"),
  lastSentLang: text("last_sent_lang"),
